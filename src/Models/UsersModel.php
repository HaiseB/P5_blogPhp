...
class UsersModel extends Model {
    ...
    public function findUserByName(array $submit) :?object {
        $query = "SELECT name, password, is_admin FROM Users WHERE is_deleted = false AND is_registered = true AND name= :name LIMIT 1";
    ...
    public function createNewUser(array $submit) :void {
        ...
        $insert = "INSERT INTO user (post_id, user_name, content, is_confirmed, created_at, updated_at, is_deleted)
